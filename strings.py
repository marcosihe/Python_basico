...
print('La cantidad de caracteres en la frase ingresada es de: ' + str(len(sentence)))

print('\n' + '*** STRIP ***')
random_word = input('Escriba una palabra con uno o más espacios al final: ')
...
print('Estas son las últimas letras que restan de su nombre:' + first_name[3:])
